...
! function(NioApp, $) {
    ...
    var totalDeposit = {
        ...
        datasets: [{
            label: "Active User",
            color: [NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), "#ccae62"],
            // @v2.0
