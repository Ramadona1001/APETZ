!(function(NioApp, $) {
    ...
    var analyticOvData = {
        ...
        datasets: [{
            ...
            color: "#ccae62",
            dash: 0,
            background: NioApp.hexRGB('#ccae62', .15),
    ...
    var OrganicSearchData = {
        ...
        datasets: [{
            ...
            color: "#ccae62",
            background: NioApp.hexRGB('#ccae62', .25),
    ...
    var TrafficChannelDoughnutData = {
        ...
        datasets: [{
            borderColor: "#fff",
            background: ["#ccae62", "#b8acff", "#ffa9ce", "#f9db7b"],
    ...
    var totalDeposit = {
        ...
        datasets: [{
            label: "Active User",
            color: [NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), "#ccae62"], // @v2.0
