!(function(NioApp, $) {
    ...
    var profileBalance = {
        ...
        datasets: [{
            ...
            color: "#ccae62",
            background: NioApp.hexRGB('#ccae62', .3),
    ...
    var salesRevenue = {
        ...
        datasets: [{
            label: "Sales Revenue",
            color: [NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), "#ccae62"], //@v2.0
    ...
    var activeSubscription = {
        ...
        datasets: [{
            label: "Active User",
            color: [NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), NioApp.hexRGB("#ccae62", .2), "#ccae62"], //@v2.0
