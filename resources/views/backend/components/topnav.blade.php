                ...
                <ul class="nk-quick-nav">
                    <li class="dropdown user-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <div class="user-toggle">
                                <div class="user-avatar sm">
                                    <span>{{ Str::upper(Str::substr(auth()->user()->first_name, 0,1)).Str::upper(Str::substr(auth()->user()->last_name, 0,1)) }}</span>
                                </div>
                                <div class="user-info d-none d-md-block">
                                    <div class="user-status">{{ transWord('Welcome') }}</div>
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    <div class="user-avatar">
                                        <span>{{ Str::upper(Str::substr(auth()->user()->name, 0,1)) }}</span>
                                    </div>
                                    <div class="user-info">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{ route('logout_users') }}"><em class="icon ni ni-signout"></em><span>Sign out</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
